...
# set default region to North America and input user API key (resets every 24 hours)
region = 'na1'
api_key = ''

#  Will execute as script, but never as imported module
if __name__ == "__main__":
    ...
    player_Party = LolTeam(api_key, region, sum_Team)
    player_Party2 = LolTeam(api_key, region, sum_Team2)
    player_Party3 = LolTeam(api_key, region, sum_Team3)
    player_Party4 = LolTeam(api_key, region, sum_Team4)
    player_Party5 = LolTeam(api_key, region, sum_Team5)
