URL = { #Predefined urls that are used to get the request from riots api by changing certain elements functions from Riot_API
...
API_VERSIONS = { #Stored version variables used as parameters from functions in Riot_API to be inserted in the request url
